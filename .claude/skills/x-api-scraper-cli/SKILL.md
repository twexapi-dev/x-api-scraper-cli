...
description: Use this skill when the task should be done through the x-api-scraper command-line client, including installing the CLI, configuring app or profile auth, previewing requests, and calling x-api-scraper endpoints through convenience commands or raw paths.
---
...
- the user wants to call supported x-api-scraper commands for users, tweets, global trending tweets, search, followers, following, lists, or follow actions
...
x-api-scraper --app prod tweet lookup 1900000000000000000
```
